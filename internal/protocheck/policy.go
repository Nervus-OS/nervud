...
var (
	...
	// 或测试没有注入 Manager，此时【必须拒绝】而不是降级成普通调用：
...
//
// operationsWired 说明本次装配有没有 Operation Manager。它是【装配事实】而不是
...
// 【之前】就建好 Operation 并把 operation_id 放进 ExecutionContext，Provider
// 收到 Dispatch 时它已经存在。
//
// 所以 ACCEPTED 对 returns_operation 的方法是合法的，且【只对它合法】：
