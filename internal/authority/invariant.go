...
type Invariants struct {
	...
	// UserDataRoot 是跨 Package 共享的用户文档区, 如 /var/lib/nervus/user-data.
	//
	...
	// SharedRuntimeRoot / SharedPersistRoot 是服务之间交换数据的公共区,
...
// CheckContainedInCodeRoot 校验 p 位于任一代码根之内 (动态安装根或系统镜像根).
//
